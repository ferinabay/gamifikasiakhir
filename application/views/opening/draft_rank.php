                ...
                foreach ($ini_rank as $key) {
                  ...
                  <tr>
                    <td><?php
                        ...
                        <img src="<?= base_url() ?>assetKu/startbootstrap-blk/assets/img/rank1.png" alt="Circle image" class="img-fluid rounded-circle shadow" style="width: 50px;  height: 50px;">
                        <br><?php
                        } else if ($rank == 2) { ?>
                        <br>
                        <img src="<?= base_url() ?>assetKu/startbootstrap-blk/assets/img/rank2.webp" alt="Circle image" class="img-fluid rounded-circle shadow" style="width: 50px;  height: 50px;">
                        <br><?php
                        } else if ($rank == 3) { ?>
                        <br>
                        <img src="<?= base_url() ?>assetKu/startbootstrap-blk/assets/img/rank3.png" alt="Circle image" class="img-fluid rounded-circle shadow" style="width: 50px;  height: 50px;">
                        <br><br><?php
                            } else {
                                echo $rank;
                              }
                    ...
                    <td align="left"><?php echo $key->nama_mhs; ?></td>
                    <td><?php echo 'Poin : ';
                        echo  $key->poin_mhs; ?></td>
