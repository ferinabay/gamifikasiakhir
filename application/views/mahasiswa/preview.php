...
<head>
	...
	<title>Form Penukaran Kompensasi</title>
...
<body>
<form action="<?=site_url()?>/mhs_c/prev" method="POST">
	<table>	
	<?php foreach ($datakompen as $key) { ?>
		
		<tr>
				<td style="width:50px">
					<center><img src="<?=base_url()?>assetKu/startbootstrap-blk/assets/img/polinema-trans.png" width="90px" height="90px" style="margin-top:30px;"></center>
				</td>

				<td class="kop" style="width:200px">
					<center>
				...
				<td style="width:50px">
					<center><img src="<?=base_url()?>assetKu/startbootstrap-blk/assets/img/iso.png" width="90px" height="90px" style="margin-top:30px;"></center>
				</td>
			</tr>
		...
		<tr>
			...
			<td colspan="2">
				<?php echo " : "; echo $key['nama_pengajar']; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2">
				<?php echo " : "; echo "Pengisian Konten Website JTI" ?>
			</td>
		</tr>
	...
	<p style="text-align: center"><a href="<?=base_url()?>index.php/cetak_c/cetakpdf/<?php echo $key['id_kmp'] ?>"> CETAK FORM KOMPEN PDF </a></p><br>
	<p style="text-align: center"><a href="<?=base_url()?>index.php/mhs_c/useKompen?>"> CANCEL </a></p><br>
	<?php } ?>
</body>
</html>